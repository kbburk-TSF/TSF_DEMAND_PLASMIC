...
import SliderThumb from "../../SliderThumb"; // plasmic-import: NIqukBUePRWl/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: I11GWu2RrgDa/css
...
function PlasmicRangeSlider__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__jdOox)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__kenGh)}>
        <div
