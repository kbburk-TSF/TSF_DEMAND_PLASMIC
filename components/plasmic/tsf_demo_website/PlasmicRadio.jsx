...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: u7p9QsN5Eu6G/css
...
function PlasmicRadio__RenderFunc(props) {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__yPoVk)}>
        <div className={classNames(projectcss.all, sty.freeBox__iiX7T)} />
      </div>
      {renderPlasmicSlot({
