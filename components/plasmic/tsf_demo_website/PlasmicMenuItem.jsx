...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: cQFH4gWqsI6A/css
...
function PlasmicMenuItem__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__yHYb)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__vmX5G)}>
            <div
              className={classNames(
                projectcss.all,
