...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: WCE14e_-3hxp/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames(projectcss.all, sty.freeBox___6FTu)}>
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__r9U89)}>
        <div
