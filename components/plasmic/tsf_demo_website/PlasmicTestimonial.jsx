...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: e318ljy9CoY1/css
...
function PlasmicTestimonial__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.column__clt8S)}>
        <h2
        ...
        >
          <div className={classNames(projectcss.all, sty.column___2Xfmw)}>
            <PlasmicImg__
              ...
              loading={"lazy"}
              src={{
                src: "/plasmic/tsf_demo_website/images/smallJpg.jpg",
                fullWidth: 160,
                fullHeight: 160,
          ...
          <div className={classNames(projectcss.all, sty.column__tyk8M)}>
            <h5
