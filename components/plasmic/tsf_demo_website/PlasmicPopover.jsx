...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: 2o2UKBpIkG0S/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: ZxYvxIcBmuUN/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__pmGwn)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__gj8CF)}
            label={"Open Popover"}
          />
        ),
