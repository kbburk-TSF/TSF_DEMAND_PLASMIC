...
import sty from "./PlasmicButton.module.css"; // plasmic-import: BmK5KSjeUCoq/css
import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: DIUuegV5WO8p/icon
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: qKX_BQGv04Jk/icon
...
function PlasmicButton__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__iw8Nm, {
          [sty.freeBoxcolor_neutral__iw8NmGl553]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__iw8NmSYny2ZfCv1]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__iw8NmIJlYe]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__iw8NmzlOny]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__iw8Nmovkul]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__iw8NmV5VMm]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__iw8NmC2Ppx]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__iw8NmZfCv1]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__uIra1, {
            [sty.freeBoxcolor_neutral__uIra1Gl553]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__uIra1Gl553PlmY]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__uIra1EIhEj]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__uIra1ZlOny]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__uIra1V5VMm]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__uIra1C2Ppx]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__uIra1ZfCv1]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__pVxZf)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__lcU1W, {
            [sty.freeBoxiconEnd__lcU1WgDiDl]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__lcU1WzlOny]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__lcU1Wv5VMm]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__lcU1Wc2Ppx]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__hYe5)}
                role={"img"}
              />
            ),
