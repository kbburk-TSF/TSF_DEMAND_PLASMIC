...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: MXjsusxMCbdw/css
import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: oSDUNQyv7LZX/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: xBeCNDwEbLQj/icon
...
function PlasmicCheckbox__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      >
        <CheckIcon
          className={classNames(projectcss.all, sty.svg__iBwr0)}
          role={"img"}
        />

        <MinusIcon
          className={classNames(projectcss.all, sty.svg___6MHc)}
          role={"img"}
        />
      </div>
      {renderPlasmicSlot({
