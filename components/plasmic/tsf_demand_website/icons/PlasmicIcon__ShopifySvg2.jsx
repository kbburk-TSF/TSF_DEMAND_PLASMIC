...
export function ShopifySvg2Icon(props) {
  ...
  return (
    ...
    >
      ...
      <path
        fill={"#5E8E3E"}
        d={
          "M221.237 54.983a19614 19614 0 0 0-23.383-1.743s-15.507-15.395-17.209-17.099c-.637-.634-1.496-.959-2.394-1.099l-12.527 256.233 89.762-19.418S223.972 58.8 223.774 57.34c-.201-1.46-1.48-2.268-2.537-2.357"
        }
      ></path>
...
export default ShopifySvg2Icon;
/* prettier-ignore-end */
