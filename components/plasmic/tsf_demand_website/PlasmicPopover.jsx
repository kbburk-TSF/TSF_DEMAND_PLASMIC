...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: wML_O15vKqe-/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: IzfdilSd2bSL/css
  ...
  return (
    <BaseDialogTrigger
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div
                  className={classNames(projectcss.all, sty.freeBox___4Jdcm)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__hxez6)}
            label={"Open Popover"}
          />
        ),
