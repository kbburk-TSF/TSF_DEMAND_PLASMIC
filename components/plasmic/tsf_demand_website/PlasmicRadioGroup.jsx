...
import Radio from "../../Radio"; // plasmic-import: WQW89dl42Vz3/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: AoyDS2sqH6DL/css
...
function PlasmicRadioGroup__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__nvPms)}>
            <Radio
              className={classNames("__wab_instance", sty.radio___8Ip1)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__f50Gl)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__qxO01)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
