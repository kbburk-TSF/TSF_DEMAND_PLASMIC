...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: Gf1isgK0DK1m/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames(projectcss.all, sty.freeBox___7917L)}>
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox___6YzeW)}>
        <div
