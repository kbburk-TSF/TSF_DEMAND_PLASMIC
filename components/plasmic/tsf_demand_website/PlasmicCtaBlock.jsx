...
import sty from "./PlasmicCtaBlock.module.css"; // plasmic-import: qoTEPcEAYg5b/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column___3H5Vy)}>
            <h2
          ...
          <div className={classNames(projectcss.all, sty.column__tfdIm)}>
            <Button
