...
import TextInput from "../../TextInput"; // plasmic-import: 71HDskp6d7Kr/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: 6lr4hoaL0H7k/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: 21UNPRpdDW_C/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__fq4L1, {
          [sty.freeBoxiconEnd__fq4L14Imr]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__fq4L1EfAWm]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__fq4L1BWj0D]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__kNlwh, {
            [sty.freeBoxiconStart__kNlwhEfAWm]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__kNlwHbWj0D]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__v3XW6)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__gwkYk, {
            [sty.freeBoxiconEnd__gwkYk4Imr]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__gwkYkEfAWm]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__qxc96)}
                role={"img"}
              />
            ),
